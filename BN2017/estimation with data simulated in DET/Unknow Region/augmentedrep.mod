...
parameters Tau kappa rho_R rho_g rho_z psi1 psi2 rstar piestar alpha ;
...
estimated_params;
alpha, 1.5 ,uniform_pdf, , ,0,2;
psi1, 0.8, , ,gamma_pdf,1.1,0.5;
...
estimation(datafile=nicolodeter, xls_range=A1:C501,mode_compute=0,mode_file=augmentedrep_mode,mh_replic=250000,mh_drop=0.5, mh_jscale=0.35,graph_format=(pdf,fig),mode_check);
