...
estimation(datafile=nicolodeter, xls_range=A1:C501,mode_compute=0,mode_file=augmentedrep_mode,mh_replic=250000,mh_drop=0.5, mh_jscale=0.4,graph_format=(pdf,fig),mode_check);
